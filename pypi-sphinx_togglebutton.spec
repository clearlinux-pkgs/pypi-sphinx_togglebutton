...
pushd ..
cp -a sphinx-togglebutton-0.2.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656369717
...
cp %{_builddir}/sphinx-togglebutton-0.2.3/LICENSE %{buildroot}/usr/share/package-licenses/pypi-sphinx_togglebutton/04f302f55e177936c00dce6b36ca9cf0c4e007ff
